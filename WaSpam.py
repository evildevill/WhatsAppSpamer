...
# we are not responsible to any illegal activity
# ---------------------------------------------------------------
...
def logo():
	os.system('clear')
	auth=m+'  Author : '+k+'Hacker wasii'
	# If you want to add a variable and change the data for Hacker wasii, you can add% s to add the variable and change it to a string,% d = change the data to decimal,% i = change the data to an integer
	return '''
%s╭━┳━╭━╭━╮%s╮╲╲╲╲╲╲%s╔═╗╔═╗╔═╗╔╦╗
%s┃┈┈┈┣▅╋▅┫┃%s╲╲╲╲╲╲%s╚═╗╠═╝╠═╣║║║
%s┃┈┃┈╰━╰━━━━━━╮%s╲╲%s╚═╝╩  ╩ ╩╩ ╩
